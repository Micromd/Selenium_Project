...
Feature: Account
  ...
  Scenario: User can create a new teacher account in taxable state using Zip Code
    ...
    And I put in my First Name as 'Luke'
    And I put in my Last Name as 'Skywalker'
    And I put in my Email Address as 'Forcewithus@gmail.com'
    And I put in my password as 'QWEr1234'
  ...
  Scenario: User can create a new teacher account in taxable state using School Search
    ...
    And I click on next
    Then I put in my Title as 'Mr.'
    And I put in my First Name as 'Darth'
    And I put in my Last Name as 'Vader'
    And I put in my Email Address as 'Iamyourfather@gmail.com'
    And I put in my password as 'QWEr1234'
    And I click on the terms and use agreement box
    Then I click on next after the TOS agreement
  ...
  Scenario: User can create a new teacher account in non-taxable state using Zip Code
    ...
    And I click on next
    Then I put in my Title as 'Mr.'
    And I put in my First Name as 'Yoda'
    And I put in my Last Name as 'Master'
    And I put in my Email Address as 'Readyyouarenot@gmail.com'
    And I put in my password as 'QWEr1234'
    And I click on the terms and use agreement box
    Then I click on next after the TOS agreement
